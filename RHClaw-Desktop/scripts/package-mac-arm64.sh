...
FULL_OFFLINE_MANIFEST="release/openclaw-bootstrap/full-offline-only/macos-arm64/manifests/full-offline-materials.json"
FULL_OFFLINE_ROOT="release/openclaw-bootstrap/full-offline-only/macos-arm64"
